...
const NEIGHBORHOOD_INDEX = 'neighborhood';

var dbPromise = idb.open(DB_NAME, 3, function(upgradeDb){
    console.log('Known DB: '+upgradeDb.oldVersion);
    switch(upgradeDb.oldVersion){
        case 0:
            upgradeDb.createObjectStore(RESTAURANTS, { keyPath:'id'});
        case 1:
            var restStore = upgradeDb.transaction.objectStore(RESTAURANTS);
            restStore.createIndex(NEIGHBORHOOD_INDEX,'neighborhood');
            restStore.createIndex(CUISINE_INDEX,'cuisine_type');
    }
